...
\title{\parbox{\linewidth}{\fontseries{bx}\selectfont {\fontsize{98}{98}\selectfont {Identifying Research Software Developer Personas \\Could Create Better RS Developers. Are *YOU* an RS-10X?}}}}
...
% \block{1: Research Goals \& Methods}{
    ...
    \begin{tikzfigure}[Exploring developer impact using item assignment \\ and contributions data in 10 RS repositories]
        ...
        \includegraphics[width=0.92\linewidth]{AverageCommitsByCategory.jpg}
    \end{tikzfigure}  

    \vspace*{0.5em}

    \textbf{Personas may explain developer influences} on:  
    %\vspace{0.25em}
    \begin{itemize}
    \setlength{\itemindent}{1em}
